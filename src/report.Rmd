...
ohnuté tak, že je téměř vodorovně s podlahou, pokouším se sedět co
možná nejvíce v klidu, v duchu odpočítám 20s a záznam dat vypnu.
...
Protože potřebuji získat údaj o velikosti třesu, nejlépe jako jedno číslo a nepotřebuji
prostorové rozložení, vypočtu velikost vektoru zrychlení jako
