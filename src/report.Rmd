...
Za předpokladu, že maximální výchylka $\varphi_m$ není velká, takže $\sin \varphi \approx \varphi$, což se v tomto případě dá předpokládat, pak pro kyvadlo platí:

$$\ddot{\varphi} + \omega_0^2 \varphi = 0$$

Řešením této diferenciální rovnice pak je:

$$\varphi(t) = \varphi_m \cos(\omega_0 t)$$

Z pohybu po kružnici pak dostaneme rovnice pro tečné a dostředivé zrychlení:

$$a_t = r \ddot{\varphi} = -r\omega_0^2\varphi = -r\omega_0^2 \varphi_m \cos(\omega_0^2 t)$$
